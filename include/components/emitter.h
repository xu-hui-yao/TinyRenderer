...
M_NAMESPACE_BEGIN
	...
	public:
		 ...
		 */
		[[nodiscard]] virtual std::pair<DirectionSample3f, Color3f> sample_direction(
			const Intersection3f& ref, const Point2f& sample,
			bool& active) const = 0;
		 ...
		 */
		[[nodiscard]] virtual std::pair<PositionSample3f, float> sample_position(
			const Point2f& sample, bool& active) const = 0;
