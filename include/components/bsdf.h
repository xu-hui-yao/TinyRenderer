...
M_NAMESPACE_BEGIN
	...
	public:
    	 ...
    	 */
		[[nodiscard]] virtual std::pair<BSDFSample3f, Color3f> sample(const SurfaceIntersection3f& si,
		                                                              float sample1,
		 ...
		 * \param active
	 	 */
		[[nodiscard]] virtual Color3f eval(const SurfaceIntersection3f& si,
		                                   const Vector3f& wo,
		                                   bool active) const = 0;
		 ...
		 * \param active
		 */
		[[nodiscard]] virtual float pdf(const SurfaceIntersection3f& si,
		                                const Vector3f& wo,
		                                bool active) const = 0;
